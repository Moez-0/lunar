  ...
  return (
    <div className="bg-primary text-white py-20 w-full h-screen flex items-center justify-center mt-[80px]">
      <div className="text-center px-4 max-w-3xl">
        ...
        <h5 className="text-lg md:text-xl text-gray-300 mb-6 leading-relaxed">Luna is your interactive study assistant, designed to help you stay focused, track progress, and achieve your goals effortlessly.</h5>
